  ...
  return (
    <div className="container mx-auto max-w-3xl px-6 py-10 space-y-6">
      ...
      <section className="rounded-3xl border border-border bg-card p-6 shadow-card">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Input your university's own API credentials to redirect event fees directly to your accounts.
        </p>
        <div className="mt-6 space-y-6 divide-y divide-border/60">
          <div className="pt-2">
            ...
            <Button onClick={() => saveKeys("razorpay", rzpKeyId, rzpKeySecret)}
          ...
          <div className="pt-6">
            ...
            <Button onClick={() => saveKeys("cashfree", cfAppId, cfSecretKey)}
      ...
      <section className="rounded-3xl border border-border bg-card p-6 shadow-card">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Platform-enabled provider methods. Custom integrations take precedence when saved above.
        </p>
